...
namespace BookCrossTest
{
    ...
    public class BooksTest
    {
        ...
        public void PublishAll()
        {
            ...
            allBooks.Publish(1, "Л. Н. Толстой", "Анна Каренина", "1877");
        ...
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "Л. Н. Толстой", "Анна Каренина", "");
            List<string> bookData = allBooks.GetAll(1);
            Assert.AreEqual(bookData[0], "1");
            Assert.AreEqual(bookData[1], "Л. Н. Толстой");
            Assert.AreEqual(bookData[2], "Анна Каренина");
        ...
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "", "Анна Каренина", "1877");
            List<string> bookData = allBooks.GetAll(1);
            Assert.AreEqual(bookData[0], "1");
        ...
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "", "Анна Каренина", "");
            List<string> bookData = allBooks.GetAll(1);
            Assert.AreEqual(bookData[0], "1");
            Assert.AreEqual(bookData[1], "");
            Assert.AreEqual(bookData[2], "Анна Каренина");
        ...
        public void CompareSame()
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "Л. Н. Толстой", "Анна Каренина", "1877");
            allBooks.Publish(2, "Л. Н. Толстой", "Анна Каренина", "1877");
        ...
        public void CompareNoAuthor()
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "Л. Н. Толстой", "Анна Каренина", "1877");
            allBooks.Publish(2, "", "Анна Каренина", "1877");
        ...
        public void CompareNoName()
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "Л. Н. Толстой", "Анна Каренина", "1877");
            allBooks.Publish(2, "Л. Н. Толстой", "", "1877");
            Assert.IsFalse(allBooks.Compare(1, 2));
        }
        ...
        public void CompareNoYear()
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "Л. Н. Толстой", "Анна Каренина", "1877");
            allBooks.Publish(2, "Л. Н. Толстой", "Анна Каренина", "");
            Assert.IsFalse(allBooks.Compare(1, 2));
        }
        ...
        public void CompareOnlyName()
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "Л. Н. Толстой", "Анна Каренина", "1877");
            allBooks.Publish(2, "", "Анна Каренина", "");
            Assert.IsFalse(allBooks.Compare(1, 2));
        }
        ...
        public void CompareOnlyAuthor()
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "Л. Н. Толстой", "Анна Каренина", "1877");
            allBooks.Publish(2, "Л. Н. Толстой", "", "");
            Assert.IsFalse(allBooks.Compare(1, 2));
        }
        ...
        public void SearchByAuthor()
        {
            Books allBooks = new Books();
            allBooks.Publish(1, "Л. Н. Толстой", "Анна Каренина", "1877");
            allBooks.Publish(2, "Л. Н. Толстой", "Война и мир", "1873");
